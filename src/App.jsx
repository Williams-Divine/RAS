...
export default function RAS() {
  ...
  return (
    <div style={{...page,paddingTop:0,color:C.tx}}>
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"22px 0 8px"}}>
        ...
        <div style={{display:"flex",gap:8,alignItems:"center"}}>
          <button onClick={()=>go("route")} style={{display:"flex",alignItems:"center",gap:6,background:C.bgCard,border:"1px solid "+C.bdr,borderRadius:20,padding:"6px 14px",cursor:"pointer"}}>
            <Map size={12} color={C.primary} style={{flexShrink:0}}/>
            <span style={{fontSize:12,fontWeight:600,color:C.primary,whiteSpace:"nowrap"}}>Check Route</span>
          </button>
  ...
  case "accessibility": return (
    <div style={{...page,color:C.tx}}>
      ...
      <div style={Card()}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          <div><p style={{fontSize:14,fontWeight:500,color:C.tx}}>Simple Mode</p><p style={{fontSize:11,color:C.txs}}>3 large buttons only</p></div>
          <div style={{display:"flex",gap:10,alignItems:"center"}}>
